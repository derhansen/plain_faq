...
final class PilistdetailContentPreview extends AbstractPluginPreview
{
    #[AsEventListener('plainfaq/pilistdetail-preview')]
    public function __invoke(PageContentPreviewRenderingEvent $event): void
    {
        if ($event->getTable() !== 'tt_content' ||
            $event->getRecordType() !== 'plainfaq_pilistdetail'
        ) {
            return;
        }
